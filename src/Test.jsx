                ...
                <div className="w-full min-h-[100vh] lg:px-4  px-2 mb-4 flex flex-col gap-3  ">
                   ...
                   <AnimatePresence>
                        <div id="about" className="  w-full min-h-full flex flex-col lg:flex-row items-center justify-center lg:bg-gradient-to-br from-stone-900 to-slate-800 bg-opacity-10 backdrop-blur-md rounded-lg md:gap-2 gap-0">
                            ...
                            >
                                <div className="profile-card xl:h-[40vh]  md:min-h-[80vh] w-full backdrop-blur-lg bg-opacity-10 bg-orange-300 border-2 border-blue-600 p-4 xl:p-4 md:py-16 sm:p-4">
                                    <motion.div
                                    ...
                                    <div>
                                        ...
                                        <div className="skills-bar bg-gray-200 rounded-lg">
                                            <motion.div
                                                ...
                                                viewport={{ once: true }}
                                                className="bg-yellow-600 h-2 rounded-lg"
                                            />
                                        </div>
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.8, ease: "easeOut" }}
                            >
                                <div className="inner rounded-lg w-full xl:h-[40vh]   md:min-h-[80vh] flex flex-wrap gap-4 items-center justify-center  backdrop-blur-lg bg-opacity-10 bg-orange-300 border-2 border-blue-600 xl:py-12 lg:p-8 p-4 mt-6 mb-6">
                                    {[
                                        ...
                                        <motion.div
                                            key={index}
                                            className="lg:p-2 p-4 sm:p-3  rounded-lg border border-orange-600 hover:bg-white backdrop-blur-lg bg-opacity-10 bg-orange-400"
                                            whileHover={{
                                                scale: 1.1,
                                                rotate: 5,
